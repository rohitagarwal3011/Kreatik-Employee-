...
public class AddEmployeeFragment extends Fragment implements View.OnClickListener{
    ...
    private com.app.rbc.employee.models.db.models.Employee editEmployee;

    private com.app.rbc.employee.models.db.models.Employee state_store;
    ...
    private void initializeUI() {
        ...
        if(edit == true) {
            editEmployee = com.app.rbc.employee.models.db.models.Employee
                    .findById(com.app.rbc.employee.models.db.models.Employee.class,editId);
            ...
            List<com.app.rbc.employee.models.db.models.Employee> state_stores = com.app.rbc.employee.models.db.models.Employee.find(
                    com.app.rbc.employee.models.db.models.Employee.class,"statestore = ?",1+"");
    ...
    public void onPause() {
        if(save_state_store) {
            if (edit != true) {
                com.app.rbc.employee.models.db.models.Employee state_store;
                if (this.state_store == null) {
                    state_store = new com.app.rbc.employee.models.db.models.Employee();
                } else {
    ...
    public void deleteStateStores() {
        List<com.app.rbc.employee.models.db.models.Employee> state_stores =
                com.app.rbc.employee.models.db.models.Employee.find(com.app.rbc.employee.models.db.models.Employee.class,
                        "statestore = ?",1+"");
        com.app.rbc.employee.models.db.models.Employee.deleteInTx(state_stores);
    }
