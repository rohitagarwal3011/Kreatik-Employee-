...
import com.app.rbc.employee.activities.AttendanceActivity;
import com.app.rbc.employee.interfaces.ApiServices;
import com.app.rbc.employee.models.EmployeewiseAttendance;
...
public class Attendance_emp_wise extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    Unbinder unbinder;
    com.app.rbc.employee.models.EmployeewiseAttendance employeewiseAttendance;
    ...
    public static Attendance_emp_wise newInstance(String user_id, String user_name,String date_send) {
        Attendance_emp_wise fragment = new Attendance_emp_wise();
        Bundle args = new Bundle();
        args.putString(USER_ID, user_id);
        args.putString(USER_NAME, user_name);
        args.putString(DATE_SEND,date_send);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            date_send= getArguments().getString(DATE_SEND);
        }
...
//        setHasOptionsMenu(true);
    ...
    public void show_profile_pic() {
        ...
        String[] user = com.app.rbc.employee.utils.AppUtil.get_employee_from_user_id(getContext(),user_id);
        ...
        profilePic.setImageURI(Uri.parse(AppUtil.getString(getContext(), TagsPreferences.PROFILE_IMAGE)));
    ...
    public void get_attendance_record(String date_send) {
        ...
        final com.app.rbc.employee.interfaces.ApiServices apiServices = com.app.rbc.employee.utils.RetrofitClient.getApiService();
        // AppUtil.logger(TAG, "User id : " + user_id + " Pwd : " + new_password.getText().toString());
        Call<com.app.rbc.employee.models.EmployeewiseAttendance> call = apiServices.emp_wise_attendance(user_id, date_send);
        //AppUtil.logger("Date :", String.valueOf(new SimpleDateFormat("yyyy-MM-dd").format(Calendar.getInstance().getTime())));
        com.app.rbc.employee.utils.AppUtil.logger("Attendance Activity ", "Get Attendance for Employee : " + call.request().toString() + "USER_ID :" + user_id);
        call.enqueue(new Callback<com.app.rbc.employee.models.EmployeewiseAttendance>() {
            @Override
            public void onResponse(Call<com.app.rbc.employee.models.EmployeewiseAttendance> call, Response<com.app.rbc.employee.models.EmployeewiseAttendance> response) {
                pDialog.dismiss();
                if (response.body().getMeta().getStatus() == 2) {

                    employeewiseAttendance = new Gson().fromJson(new Gson().toJson(response.body()), com.app.rbc.employee.models.EmployeewiseAttendance.class);
                    ...
                    com.app.rbc.employee.utils.AppUtil.showToast(getContext(), response.body().getMeta().getMessage());
                    show_date_selector();
                }
            ...
            @Override
            public void onFailure(Call<com.app.rbc.employee.models.EmployeewiseAttendance> call1, Throwable t) {

                pDialog.dismiss();


                com.app.rbc.employee.utils.AppUtil.showToast(getContext(), "Network Issue. Please check your connectivity and try again");
            }
        });
    }
    ...
    private void show_week_dialog(String leave_type) {
        ...
        for (int i = 0; i < employeewiseAttendance.getWeekData().size(); i++) {
            ...
            if (employeewiseAttendance.getWeekData().get(i).getStatus().equalsIgnoreCase(leave_type)) {
                ...
                com.app.rbc.employee.utils.AppUtil.logger("Final date : ", fmtout.format(formated));
...
//        LinearLayout dates = (LinearLayout)dialog.findViewById(R.id.dates);
    ...
    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        com.app.rbc.employee.utils.AppUtil.logger(TAG, "Date : " + date_send);
        date_search = true;
        get_attendance_record(date_send);
    ...
    public void get_month_record(final String month, final String year) {
        ...
        final com.app.rbc.employee.interfaces.ApiServices apiServices = com.app.rbc.employee.utils.RetrofitClient.getApiService();
        // AppUtil.logger(TAG, "User id : " + user_id + " Pwd : " + new_password.getText().toString());
        Call<com.app.rbc.employee.models.EmployeewiseAttendance> call = apiServices.monthwise_search(user_id, year, month);
        //AppUtil.logger("Date :", String.valueOf(new SimpleDateFormat("yyyy-MM-dd").format(Calendar.getInstance().getTime())));
        com.app.rbc.employee.utils.AppUtil.logger("Attendance Activity ", "Get Attendance for Employee : " + call.request().toString() + "USER_ID :" + user_id + "month " + month + " year " + year);
        call.enqueue(new Callback<com.app.rbc.employee.models.EmployeewiseAttendance>() {
            @Override
            public void onResponse(Call<com.app.rbc.employee.models.EmployeewiseAttendance> call, Response<com.app.rbc.employee.models.EmployeewiseAttendance> response) {
                pDialog.dismiss();
