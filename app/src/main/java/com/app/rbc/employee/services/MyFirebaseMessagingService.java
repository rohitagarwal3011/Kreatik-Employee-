package com.app.rbc.employee.services;
...
//
            ...
            else if (remoteMessage.getData().get("type").equalsIgnoreCase("new_req"))
            {
                ...
                intent.putExtra("category",category);
                intent.putExtra("rq_id",parent_id);
                intent.putExtra("type",remoteMessage.getData().get("type"));
            ...
            else if (remoteMessage.getData().get("type").equalsIgnoreCase("vehicle"))
            {
                String category= remoteMessage.getData().get("category");
                String parent_id=remoteMessage.getData().get("parent_id");

                PendingIntent pendingIntent;
                if(remoteMessage.getData().get("vehicle_for").equalsIgnoreCase("po"))
                {
                    Intent intent = new Intent(this, StockActivity.class);
                    intent.putExtra("category",category);
                    intent.putExtra("po_id",parent_id);
